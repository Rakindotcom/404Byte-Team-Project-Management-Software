                ...
                <div className="flex justify-between h-16">
                    ...
                    <div className="flex items-center space-x-8">
                        <Link to="/dashboard" className="flex items-center space-x-2 group">
                            <img
                                src="/logo.png"
                                alt="404Team"
                                className="w-8 h-8 rounded-lg shadow-lg group-hover:shadow-[--shadow-glow] transition-all duration-300"
                            />
                            <span className="text-lg font-bold text-gradient hidden sm:block">404Team</span>
                        </Link>
                            ...
                            {navLinks.map((link) => (
                                <Link
                                    ...
                                    className={`flex items-center space-x-2 px-4 py-2 text-sm font-medium rounded-lg transition-all duration-200 ${isActive(link.to)
                                        ? 'bg-linear-to-r from-[--accent-cyan]/20 to-[--accent-purple]/20 text-[--accent-cyan] border border-[--accent-cyan]/30'
                    ...
                    <div className="flex items-center space-x-4">
                        <div className="relative">
                            ...
                            >
                                <div className="avatar avatar-md bg-linear-to-br from-[--accent-cyan] to-[--accent-purple] text-white">
                                ...
                                <div className="hidden md:block text-left">
                                    ...
                                    {isAdmin && (
                                        <div className="text-xs text-[--accent-purple]">Admin</div>
                                    )}
                                </div>
                                <svg
