    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <div className="absolute w-96 h-96 -bottom-48 -right-48 bg-linear-to-br from-[--accent-purple]/20 to-transparent rounded-full blur-3xl animate-pulse-slow" style={{ animationDelay: '1s' }}></div>
            ...
            <div className="max-w-sm w-full relative z-10">
                ...
                <div className="text-center mb-8 animate-fade-in-down">
                    <img
                        src="/logo.png"
                        alt="Team404"
                        className="w-20 h-20 mx-auto rounded-2xl shadow-lg mb-4 animate-glow"
                    />
                    <h1 className="text-3xl font-bold text-gradient">Team404</h1>
