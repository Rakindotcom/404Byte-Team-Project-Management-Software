...
export default function DashboardPage() {
    ...
    const statusColors = {
        ...
        'in-progress': 'from-[--accent-cyan] to-blue-500',
        review: 'from-[--accent-purple] to-purple-600',
        'need-fixing': 'from-[--accent-yellow] to-orange-500',
        done: 'from-[--accent-green] to-emerald-600'
    };
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        <h1 className="text-2xl md:text-3xl font-bold text-[--text-primary]">
                            {getGreeting()}, <span className="text-gradient">{userProfile?.name?.split(' ')[0] || 'there'}</span>!
                        </h1>
                        ...
                        <div className="flex flex-col md:flex-row md:items-center gap-6">
                            ...
                            <div>
                                ...
                                <p className="text-[--text-muted] text-sm flex items-center gap-1 flex-wrap">
                                    ...
                                    {completionRate >= 75 ? (
                                        <span className="inline-flex items-center gap-1 text-[--accent-green]"> Great job!
                                        ...
                                        <span className="inline-flex items-center gap-1 text-[--accent-purple]"> You got this!
                ...
                {isAdmin && (
                    <div className="glass-card-static p-6">
                        <h2 className="font-semibold text-[--text-primary] mb-4 flex items-center space-x-2">
                            ...
                            <span className="badge badge-purple">{tasks.length} total</span>
                        </h2>
